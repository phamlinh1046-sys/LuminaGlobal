...
<head>
  ...
  <title>Lumina — <?= $lang === 'vi' ? 'Lộ trình' : 'Learning Path' ?></title>
...
<body>
  ...
  <h1 class="coming-h"><?= $lang === 'vi' ? 'Lộ trình phát triển' : 'Learning Path' ?></h1>
  <p class="coming-sub"><?= $lang === 'vi' ? 'Lộ trình cá nhân hoá đang được xây dựng. Sắp ra mắt!' : 'Personalized pathways are coming soon!' ?></p>
